...
import { randomBoolean } from "../../../../shared/utils/randomBoolean";
import { Todo } from "../Todo/Todo.component";
import { WatchExample } from "../WatchExample/WatchExample.component";
...
export class CounterJSX extends Component<{ name: Observable<string> }> {
  ...
  render() {
    const inc = async () => this.count.next((await unwrap(this.count)) + 1);
    const dec = async () => this.count.next((await unwrap(this.count)) - 1);
